/// @description Begin dialogue between player and messageGiver
//Create the dialogue box in the middle of the screen
dialogueBox = instance_create(__view_get( e__VW.WPort, view_current ) / 2 , __view_get( e__VW.HPort, view_current ) / 2, objDialogueBox);
